            ...
            <div class="modal-content float-none p-0 mx-auto">
                <div class="modal-body">
                    ...
                    <div class="form-container">
                        ...
                        <div class="mt-2">
                            <a href="/" style="color: black;"><button type="button" class="btn btn-submit btn-login btn-block text-uppercase"><?php echo app('translator')->get('Return to Home Page'); ?></button></a>
                        </div>
                        <div class="mt-5">
                            <p class="text-white mb-2 futura-medium"><?php echo app('translator')->get('not_registered'); ?></p>
                            <button type="button" id="Loginbtn1" class="btn btn-submit btn-login btn-block text-uppercase"><?php echo app('translator')->get('not_registered'); ?></button>
                        </div>
                    </div>
