...
@foreach($query as $row)
    ...
    <div id="{{$row->OrderId}}" class="order-box p-3 favourite-box data-row">
            ...
            <div class="order-info py-2 py-md-4 cursor-pointer" data-toggle="collapse" data-target=".order-history-{{$row->OrderId}}" id="order-{{$row->OrderId}}" aria-expanded="true" aria-controls="order-div-{{$row->OrderId}}">
                ...
                <div class="order-history-details order-history-{{$row->OrderId}} collapse"  aria-labelledby="order-{{$row->OrderId}}" id="order-div-{{$row->OrderId}}"  data-parent="#orderexpanded">
                    <div class="row">
